...
export function Header({ toggleFunction }: { toggleFunction: CallableFunction }) {
    return (
        <Navbar expand="lg" className="bg-body-tertiary" fixed="top">
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav" role={null}>
                    ...
                    <Navbar.Text className="btn d-block ms-auto" onClick={(e) => toggleFunction(e)} aria-label="Change Theme Colour">
